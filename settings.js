// ✅ MegaTron Bot Stylish Configuration – by 𝗔𝗧𝗧𝗔 𝗣𝗔𝗧𝗛𝗔𝗡 ❦ ✓

const ownerNumber = require('./Owner/owner'); // 🔗 Example: ['923219907546']

const config = {
  // 👑 Owner Info
  ownerNumber,                          // 🔹 Array of Owner Numbers
  ownerName: '𓆩 𝗔𝗧𝗧𝗔 𝗣𝗔𝗧𝗛𝗔𝗡 ❦︎𓆪',              // 🔹 Displayed in Greetings
  botName: '🤖 𝗠𝗘𝗚𝗔𝐓𝐑𝐎𝐍 𝑩𝑶𝑻 ⚡',           // 🔹 Bot Display Name
  signature: '> 𝗔𝗧𝗧𝗔 ❦ ✓',               // 🔹 Footer on Bot Replies
